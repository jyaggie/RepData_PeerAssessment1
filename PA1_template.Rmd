...
```
The average daily activity is `r avgsteps` steps with median `r mediansteps`.  The median and mean are very similar when the NA values have been dropped.  Therefore, the data is evenly distributed around the mean.
